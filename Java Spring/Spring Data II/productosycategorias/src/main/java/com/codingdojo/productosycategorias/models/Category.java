...
public class Category {
	...
	@Size(min = 5, max = 45, message = "Category name must have between 5 and 45 characters.")
	private String name;
	...
	public Category(
			@Size(min = 5, max = 45, message = "Category name must have between 5 and 45 characters.") String name) {
		this.name = name;
	}
